	...
	public Formulario() {
		...
		btnFeijaoMais.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtQuantidade.setText(String.valueOf(i+1));
		...
		btnFeijaoMenos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				a.suntrair(0);
				int i = Integer.parseInt(txtQuantidade.getText());
				if(i<=0) {
					JOptionPane.showMessageDialog(null, "Impossivel realizar a ação!");
				}else {
				txtQuantidade.setText(String.valueOf(i-1));
				}
			}
			...
			public void actionPerformed(ActionEvent e) {
				String f ="";
					for(int i=0;i<Array.Lista.size();i++){
						f+=Array.Lista.get(i).getNome()+" -> "+Array.Lista.get(i).getQuantidade();
						f+="\n";
					}
