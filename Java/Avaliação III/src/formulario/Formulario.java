	...
	public Formulario() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textArea.setText(a.contadorDeCargo()+
								...
								"\nQuantidade de colaboradores que aderiram ao plano de saúde: "+a.contadorPlano()+
								a.contadorFaltas());
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(b.getNome().contentEquals(Array.Colaborador.get(indice).getNome())) {
					a.edit(b,indice);
				...
				}else if(a.validacao(b)&&cbxCARGO.getSelectedIndex()!=0) {
					a.edit(b,indice);
				...
				JOptionPane.showMessageDialog(null, "Nome ja utilizado ou incorreto");
